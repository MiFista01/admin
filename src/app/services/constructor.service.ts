  ...
  public styles = [
    ...
    },
    {
      ...
      group:[
        ...
        { name: 'Border Color', value: 'border-color', type:"user-size" },
        { name: 'Border Style', value: 'border-style', type:"user-size" },
    ...
    },
    {
      ...
      group:[
        ...
        { name: 'justify content', value: 'justify-content', type:"user-select", values:["center","start","end","left","right"]},
